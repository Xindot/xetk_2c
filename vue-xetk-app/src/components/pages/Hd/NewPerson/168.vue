...
export default {
  data() {
    return {
      nativeAppInfo: null,
      list: [
        "https://s1.nianran.net/static/d3lemon/assets/img/hd/168/168_01@2x.png",
        "https://s1.nianran.net/static/d3lemon/assets/img/hd/168/168_02@2x.png",
        "https://s1.nianran.net/static/d3lemon/assets/img/hd/168/168_03@2x.png",
        "https://s1.nianran.net/static/d3lemon/assets/img/hd/168/btn@2x.png",
        "https://s1.nianran.net/static/d3lemon/assets/img/hd/168/168_04@2x.png"
      ],
      header: {
        visible: true
      },
      shareObj: {
        ...
        desc: "新人注册领168元优惠券，先到先得", // 分享描述
        url: "", // 分享链接
        img: "https://h5.gushitech.com/oilv2/logo/logo-1@2x-w50.png" // 分享图标
      }
    };
  },
  created() {
  ...
  methods: {
    getShareUrl() {
      ...
      const href =
        window.location.origin + window.location.pathname + "#/hd/168";
